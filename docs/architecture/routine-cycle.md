...
| 5 `route.select`      | routing                                                       | action capability + evidence snapshot + complete installed active-release worker-host census                                                                | `route-selection/v1` binding one admitted opaque worker-host identity                                                                                                                                   | immediately before dispatch plan                                                         | route → 6; no supported route → `FAILED_KNOWN`; identity unknown → `UNKNOWN`                                                                                                      |
