...
in the installed active-release manifest. The candidate or worker cannot supply
this equality. A moved plan, descriptor, role, catalog, subject, host identity,
host-renderer artifact, or rendered-byte digest refuses before ownership
publication.
