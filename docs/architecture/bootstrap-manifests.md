...
value/core, commit evidence, evidence slot/packet, and the eleven-kind
registry. Superseded
...
| missing, malformed, unknown, future, legacy fixture, or old authority at a current path | refused |
