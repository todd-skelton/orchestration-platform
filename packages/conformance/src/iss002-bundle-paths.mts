export const iss002HarnessPaths = Object.freeze([
  ...
  "packages/contracts/src/module-plan.ts",
  "packages/contracts/src/owner.ts",
  "packages/contracts/src/packet.ts",
  "packages/contracts/src/pointer.ts",
  "packages/contracts/src/project-breaker-facts.ts",
  "packages/contracts/src/project-mutation.ts",
  "packages/contracts/src/project-preflight.ts",
  "packages/contracts/src/project-snapshot.ts",
  "packages/contracts/src/recovery.ts",
  "packages/contracts/src/registry.ts",
  "packages/contracts/src/repository-protection-binding.ts",
  ...
  "packages/contracts/src/review-result.ts",
  "packages/contracts/src/review-subject.ts",
  "packages/contracts/src/route-selection.ts",
  "packages/contracts/src/routine-step.ts",
  ...
  "packages/contracts/src/verifier-anchor.ts",
...
export const iss002TestBundlePaths = Object.freeze([
  ...
  "test/contracts/breaker-receipt.test.ts",
  "test/contracts/commit.test.ts",
  "test/contracts/compatibility.test.ts",
  "test/contracts/configuration.test.ts",
  "test/contracts/cycle-entry.test.ts",
  "test/contracts/dispatch-lifecycle.test.ts",
  "test/contracts/dispatch.test.ts",
  "test/contracts/disposition.test.ts",
  ...
  "test/contracts/journal.test.ts",
  "test/contracts/lifecycle.test.ts",
  "test/contracts/module-plan.test.ts",
  "test/contracts/owner.test.ts",
  "test/contracts/pointer.test.ts",
  "test/contracts/project-breaker-facts.test.ts",
  "test/contracts/project-mutation.test.ts",
  "test/contracts/project-preflight.test.ts",
  "test/contracts/project-snapshot.test.ts",
  ...
  "test/contracts/repository-protection-binding.test.ts",
  "test/contracts/repository-protection.test.ts",
  "test/contracts/reservation-identity.test.ts",
  "test/contracts/reservation-value.test.ts",
  "test/contracts/resource-reclaim.test.ts",
  "test/contracts/review-request.test.ts",
  "test/contracts/review-result.test.ts",
  "test/contracts/review-subject.test.ts",
  "test/contracts/route-selection.test.ts",
  "test/contracts/routine-step.test.ts",
