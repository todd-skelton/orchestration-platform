...
export type FramePart =
  ...
  | { readonly type: "bounded-decimal"; readonly value: string }
...
function framePartBytes(part: FramePart): Uint8Array {
  ...
  if (part.type === "bounded-decimal" && !isCanonicalDecimal(part.value))
    throw new TypeError("frame:invalid-bounded-decimal");
...
export const frame = Object.freeze({
  ...
  boundedDecimal: (value: string): FramePart => Object.freeze({ type: "bounded-decimal", value }),
