...
export function validateGenesisSelectionEvidenceBinding(
  ...
  const comparisons: readonly (readonly [string, unknown, unknown])[] = [
    ...
    ["history.globalIdentityDigest", h.globalIdentityDigest, c.globalIdentityDigest],
    ["authority.globalIdentityDigest", av.globalIdentityDigest, c.globalIdentityDigest],
